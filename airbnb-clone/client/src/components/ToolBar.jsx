...
const ToolBar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white py-5 px-5 md:px-10 w-full h-12">
      ...
      {/* Middle */}
      <div className="flex items-center border rounded-full shadow-md border-gray-300 w-68 h-10">
        <input
        ...
        <br/>
        <SearchIcon
          className="hidden md:inline-flex h-8 bg-[#329a9a] text-white rounded-full p-2 cursor-pointer md:mx-2 absolute-right w-24"
